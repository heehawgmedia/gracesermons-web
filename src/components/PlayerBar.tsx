        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-1 flex items-center gap-2">
            ...
            <input
              ...
              aria-label="Seek"
            />
            <span className="w-10 text-[11px] tabular-nums text-stone-500">
...
function IconButton({
  ...
  return (
    <button
      ...
      disabled={disabled}
      aria-label={label}
      className="grid size-9 place-items-center rounded-full text-stone-600 hover:bg-stone-100 disabled:opacity-30"
    >
      <svg className="size-5" viewBox="0 0 24 24" fill="currentColor">
        {children}
      </svg>
